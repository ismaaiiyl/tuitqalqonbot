...
const SETTINGS_MSG_DURATION = 300000; // 5 daqiqa
...
export const handleAdmin = (bot) => {
  ...
  bot.command('settings', async (ctx) => {
    try {
      ...
      const reply = await ctx.replyWithHTML(`<b>⚙️ Guruh Sozlamalari</b>\n\nFiltrlarni yoqish yoki o'chirish uchun tugmalarni bosing. Menyusi 5 daqiqadan so'ng o'chadi:`, getSettingsMenu(s));
